...
export default function CounselorSessionPage() {
  ...
  const saveSessionNotes = async () => {
    if (!sessionNotes.trim() || !appointment) return
  ...
  const clientName = `${appointment.client?.firstName || 'Unknown'} ${appointment.client?.lastName || 'Client'}`
  const isChatSession = appointment.sessionType === "chat"

  // If it's not a chat session, show the video session placeholder
  if (!isChatSession) {
    return (
      <CounselorLayout>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-xl font-bold">Session with {clientName}</h1>
                  <p className="text-gray-600">Client Session</p>
                </div>
              </div>
                ...
                <div className="flex flex-col items-center justify-center h-full p-8">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-600 max-w-md">
                      Your video session will be available here. You'll be able to join the video call with your client.
                    </p>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <button
                  ...
                  className="mt-2 w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
                  {isSavingNotes ? (
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold">Chat Session with {clientName}</h1>
                <p className="text-gray-600">Client Session</p>
              </div>
            </div>
            <div className="text-right">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  {messages.length === 0 ? (
                    ...
                    messages.map((message) => (
                      <div
                        key={message._id}
                        className={`flex ${message.sender._id === appointment.counselor?._id ? "justify-end" : "justify-start"}`}
                      >
                        <div className="flex items-end space-x-2 max-w-xs lg:max-w-md">
                          {message.sender._id !== appointment.counselor?._id && (
